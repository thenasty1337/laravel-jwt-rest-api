...
class TagAddToGamesByProvider extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'tags:add-to-games-by-provider';
     ...
     * @var string
     */
    protected $description = 'Add a specified tag to all games matching provider/category name';
    ...
    public function handle(): int
    {
        ...
        $games = Gamelist::where("category", $namePattern)->get();
